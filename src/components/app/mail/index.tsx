...
const mailTestList: IMailProps[] = [
    ...
    },
    {
        id: 2,
        title: "David Doe",
        topic: "My Second Mail",
        date: "Friday",
        notification: false,
        content:
            "Hello John, I got the package you sent me yesterday. Thank you for that, David.",
    },
];
    ...
    return (
        <AppContainer>
            <HeaderApp
                ...
                leftText="Personal"
                rightText="Edit"
                onClickOnLeftText={() => setEdit(!edit)}
                onClickOnRightText={() => {}}
            />
            <div className="mail-box">{getMail()}</div>
        </AppContainer>
    );
};
