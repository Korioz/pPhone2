    ...
    return (
        <div className="header-app" style={{ color: headerColor }}>
            <div className="header-app-left">
                <ReactSVG
                    onClick={props.onClickOnArrow || goBack}
                    src={`${BackIcon}`}
                    fallback={() => <span>Error!</span>}
                    className="header-app-arrow"
                    style={{ fill: headerColor }}
                />
                {props.onClickOnLeftText && props.leftText && (
                    <div
                        className="header-app-left-text"
                        onClick={props.onClickOnLeftText}
                    >
                        {props.leftText}
                    </div>
                )}
            ...
            <div className="header-app-right">
                {props.onClickOnRightText && props.rightText && (
                    <div
                        className="header-app-right-text"
                        onClick={props.onClickOnRightText}
                    >
                        {props.rightText}
                    </div>
                )}
